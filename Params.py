...
def ParseArgs():
    ...
    parser.add_argument('--omega', type=float, default=2.0, help='Multiplier for uncertainty-guided diffusion noise')
    parser.add_argument('--epsilon_adv', type=float, default=0.05, help='Perturbation magnitude for FGSM')
    parser.add_argument('--lambda_adv', type=float, default=0.1, help='Adversarial Loss weight')
    parser.add_argument('--adv_warmup_epochs', type=int, default=3, help='Number of epochs before applying Adversarial Training')
    # Colab-specific
