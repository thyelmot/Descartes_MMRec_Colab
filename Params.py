...
def ParseArgs():
    ...
    parser.add_argument('--alpha_doubt', type=float, default=0.3, help='Weight for internal discrepancy D_item')
    parser.add_argument('--beta_doubt', type=float, default=0.5, help='Weight for preference deviation D_pref')
    parser.add_argument('--gamma_doubt', type=float, default=0.2, help='Weight for popularity bias T_pop')
    parser.add_argument('--omega', type=float, default=0.5, help='Multiplier for uncertainty-guided diffusion noise')
    parser.add_argument('--epsilon_adv', type=float, default=0.01, help='Perturbation magnitude for FGSM')
    parser.add_argument('--lambda_adv', type=float, default=0.03, help='Adversarial Loss weight')
    parser.add_argument('--adv_warmup_epochs', type=int, default=10, help='Number of epochs before applying Adversarial Training')
    # Colab-specific
